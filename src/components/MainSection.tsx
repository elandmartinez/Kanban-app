...
export default function MainSection () {
  return (
    <main className="w-screen relative h-[92vh] bg-veryDarkGrey text-[#828fa3] flex">
      <SideBar />

      <div className="main-section w-full text-center p-6 flex flex-col justify-center items-center transition-all duration-200">
