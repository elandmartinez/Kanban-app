...
export default function DropdownSelector ({ stages, taskData, shouldUpdateStateOnChange }: TaskSelectStageProps) {
  ...
  return (
    <div className="text-[0.85rem] font-light text-secondaryTextColor font-semibold">
      <button
      ...
      <div className={`${showStages ? "h-[155px] pt-[0px]" : "h-0 p-0"} z-10 flex flex-col transition-all duration-200 absolute w-full max-h-[155px] overflow-y-auto left-0 top-[60px] rounded-b-xl text-mainTextColor`}>
          {
